          ...
          <main>
            ...
            <ol>
              <li>
                ...
                предпринимаемые ИП «( ДУДКИН ПАВЕЛ ИГОРЕВИЧ) (далее — Оператор).
              </li>
              <li>
              ...
              <li>3. Основные права и обязанности Оператора</li>
              <li>
              ...
              <li>5. Принципы обработки персональных данных</li>
              <li>
              ...
              <li>
                ...
                <ul>
                  <li>
                    Цель обработки заключение, исполнение и прекращение
                    гражданско-правовых договоров
                  </li>
                  <li>Персональные данные фамилия, имя, отчество</li>
                  <li>электронный адрес</li>
                  <li>номера телефонов</li>
                  <li>
                    Правовые основания Федеральный закон «Об информации,
              ...
              <li>7. Условия обработки персональных данных</li>
              <li>
              ...
              <li>10. Трансграничная передача персональных данных</li>
              <li>
              ...
              <li>12. Заключительные положения</li>
              <li>
